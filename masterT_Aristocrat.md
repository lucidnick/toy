...
目標： 擊敗 「水晶之王．奧爾 (Aul, the Crystal King)」。
地點： 位於 藍晶礦坑 (Azurite Mine) 的「原初廢墟 (Primeval Ruins)」區域中，地標名為 「水晶之王王座 (Crystal King's Throne)」。
難度： 奧爾是礦坑中最難對付的隨機頭目之一，通常出現在深度 171 層以下。

雖然作者展示使用的是 霹靂鞭 (Crackling Lance)，但他強調這套增傷是「全域閃電點傷」，你可以換成任何法術：
電弧 (Arc)： 清圖超爽快。
天雷之珠 (Ball Lightning)： 單體傷害極高。
火花 (Spark)： 適合封閉地形。
